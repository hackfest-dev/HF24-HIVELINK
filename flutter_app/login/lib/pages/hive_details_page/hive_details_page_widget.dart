...
class _HiveDetailsPageWidgetState extends State<HiveDetailsPageWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<HivesRecord>(
      stream: HivesRecord.getDocument(widget.hives!),
      builder: (context, snapshot) {
        ...
        final hiveDetailsPageHivesRecord = snapshot.data!;
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 0.0, 0.0),
                              child: Text(
                                hiveDetailsPageHivesRecord.location!.toString(),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Outfit',
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 0.0, 0.0),
                              child: Text(
                                hiveDetailsPageHivesRecord.humidity.toString(),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Outfit',
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 0.0, 0.0),
                              child: Text(
                                hiveDetailsPageHivesRecord.temperature
                                    .toString(),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 0.0, 0.0),
                              child: Text(
                                hiveDetailsPageHivesRecord.supplimentQuantity
                                    .toString(),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 0.0, 0.0),
                              child: Text(
                                hiveDetailsPageHivesRecord.status,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Outfit',
